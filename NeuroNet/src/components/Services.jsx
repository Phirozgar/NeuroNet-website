...
import { neuroNetServices, neuroNetServicesIcons } from "../constants";
import {
  PhotoChatMessage,
  Gradient,
  VideoBar,
    ...
    <Section id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="NeuroNet unlocks the potential of AI-powered Application."
        />
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              <h4 className="h4 mb-4">Smartest</h4>
              <p className="body-2 mb-[3rem] text-n-3">
                NeuroNet unlocks the potential of AI-powered Application
              </p>
              <ul className="body-2">
                {neuroNetServices.map((item, index) => (
                  <li
                    key={index}
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {neuroNetServicesIcons.map((item, index) => (
                    <li
                      key={index}
